...
export SAM_AUDIO_PROMPT_STAGE1="music soundtrack"
export SAM_AUDIO_PROMPT_STAGE2="human voices"
...
export SAM_AUDIO_STAGE1_SUCCESS_THRESHOLD=4.4
export SAM_AUDIO_STAGE1_FAILURE_THRESHOLD=4.1
export SAM_AUDIO_STAGE2_SUCCESS_THRESHOLD=4.5
export SAM_AUDIO_STAGE2_FAILURE_THRESHOLD=4.3
